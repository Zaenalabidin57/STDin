...
static char *font2[] = { "ComicCodeLigaturesNerdFontComplete Nerd Font:style=Regular:pixelsize=13:antialias=true:autohint=true" };
static char *font =  "ComicCodeLigaturesNerdFontComplete Nerd Font:style=Regular:pixelsize=13:antialias=true:autohint=true" ;
//static char *font = "CodeliaLigatures Nerd Font:style=Regular:pixelsize=15:antialias=true:autohint=true";
//static char *font[] = { "ComicCodeLigaturesNerdFontComplete Nerd Font :pixelsize=12:antialias=true:autohint=true" };
//static char *font[] = { "Monocraft Nerd Font:pixelsize=13:antialias=true:autohint=true" };
