...
PinyinInitialMap pinyin_initial_map[] = {
    {"㧟", {'k'}},
    {"㩳", {'s'}},
    {"㭎", {'g'}},
    {"㳠", {'t'}},
...
// get the unicode value of the given utf8 string
unsigned int get_unicode_value(const char *utf8) {
...
const char* get_pinyin_initials(unsigned int unicode) {
    ...
    while (left <= right) {
        ...
        unsigned int mid_unicode = get_unicode_value(pinyin_initial_map[mid].hanzi);
        if (mid_unicode == unicode) {
            return pinyin_initial_map[mid].initials;
